...
var FX = {
  config: {
    background: "rgb(245,245,245)", // Arka plan rengini daha uyumlu hale getirdik
    color: "rgb(0, 0, 0)", // Metin rengi
    highlight: "rgb(250, 50, 50)", // Vurgulama rengi
  },
  dots: [],
};
...
var Dot = function (opts) {
  ...
  this.x = 0;
  this.y = 0;
  this.dest_x = opts.dest_x - 150;
  this.dest_y = opts.dest_y - 150;
};
...
FX.setFullscreen = function () {
  ...
  FX.canvas.style.width = "100%"; // Arka planın tam sayfayı kaplamasını sağlamak için eklenen stil
  FX.canvas.style.height = "100%"; // Arka planın tam sayfayı kaplamasını sağlamak için eklenen stil
};
...
FX.createHeart = function () {
  var coords = [
    ...
    k = coords.length,
    raster = 20, // Boyutu artırmak için 10 yerine 20
    i = 0;
